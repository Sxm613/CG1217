...
edaf80::Assignment3::run()
{
	...
	//auto const phong_set_uniforms = [&use_normal_mapping, &light_position, &camera_position, displacementScale](GLuint program) {
	//	glUniform1i(glGetUniformLocation(program, "use_normal_mapping"), use_normal_mapping ? 1 : 0);
	//	glUniform3fv(glGetUniformLocation(program, "light_position"), 1, glm::value_ptr(light_position));
	//	glUniform3fv(glGetUniformLocation(program, "camera_position"), 1, glm::value_ptr(camera_position));
	//	glUniform1f(glGetUniformLocation(program, "displacementScale"), displacementScale);
	//};
	...
	auto const phong_set_uniforms = [&light_position, &camera_position, metaldisplacementScale, metalambientScale, metaldiffuseScale, metalspecularScale](GLuint program) {
		glUniform3fv(glGetUniformLocation(program, "light_position"), 1, glm::value_ptr(light_position));
		glUniform3fv(glGetUniformLocation(program, "camera_position"), 1, glm::value_ptr(camera_position));
	...
	GLuint skybox_texture = bonobo::loadTextureCubeMap(
		"C:\\Users\\Ximeng\\Desktop\\CG_Labs-master\\CG_Labs-master\\res\\cubemaps\\LarnacaCastle\\posx.jpg",
		"C:\\Users\\Ximeng\\Desktop\\CG_Labs-master\\CG_Labs-master\\res\\cubemaps\\LarnacaCastle\\negx.jpg",
		"C:\\Users\\Ximeng\\Desktop\\CG_Labs-master\\CG_Labs-master\\res\\cubemaps\\LarnacaCastle\\posy.jpg",
		"C:\\Users\\Ximeng\\Desktop\\CG_Labs-master\\CG_Labs-master\\res\\cubemaps\\LarnacaCastle\\negy.jpg",
		"C:\\Users\\Ximeng\\Desktop\\CG_Labs-master\\CG_Labs-master\\res\\cubemaps\\LarnacaCastle\\posz.jpg",
		"C:\\Users\\Ximeng\\Desktop\\CG_Labs-master\\CG_Labs-master\\res\\cubemaps\\LarnacaCastle\\negz.jpg",
		true
	);
	...
	auto demo_shape = parametric_shapes::createSphere(1.5f, 1000u, 1000u);
	if (demo_shape.vao == 0u) {
		LogError("Failed to retrieve the mesh for the demo sphere");
		return;
	}

	GLuint diffuseTexture = bonobo::loadTexture2D("C:\\Users\\Ximeng\\Desktop\\CG_Labs-master\\CG_Labs-master\\res\\textures\\grass\\grass.jpg", true);
	GLuint roughnessTexture = bonobo::loadTexture2D("C:\\Users\\Ximeng\\Desktop\\CG_Labs-master\\CG_Labs-master\\res\\textures\\grass\\grass_rough.jpg", true);
	GLuint normalTexture = bonobo::loadTexture2D("C:\\Users\\Ximeng\\Desktop\\CG_Labs-master\\CG_Labs-master\\res\\textures\\grass\\grass_normal.jpg", true);
	GLuint ambientlTexture = bonobo::loadTexture2D("C:\\Users\\Ximeng\\Desktop\\CG_Labs-master\\CG_Labs-master\\res\\textures\\grass\\grass_ambient.jpg", true);
	GLuint displacementMap = bonobo::loadTexture2D("C:\\Users\\Ximeng\\Desktop\\CG_Labs-master\\CG_Labs-master\\res\\textures\\grass\\grass_displacement.jpg", true);
	...
	demo_sphere.add_texture("diffuseTexture", diffuseTexture, GL_TEXTURE_2D);
	demo_sphere.add_texture("specularTexture", roughnessTexture, GL_TEXTURE_2D);
	demo_sphere.add_texture("normalMap", normalTexture, GL_TEXTURE_2D);
	demo_sphere.add_texture("ambientlTexture", ambientlTexture, GL_TEXTURE_2D);
	demo_sphere.add_texture("displacementMap", displacementMap, GL_TEXTURE_2D);
